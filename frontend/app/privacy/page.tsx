      ...
      <Paper sx={{ p: 6, border: `1px solid ${colors.neutral.gray200}`, borderRadius: 2 }}>
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8, mb: 2 }}>
            Atlas Investor ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, disclose, and safeguard your information when you use our real estate investment
            analysis platform (the "Service").
          </Typography>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
            ...
            to use commercially acceptable means to protect your personal information, we cannot guarantee absolute
            security.
          </Typography>
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8, mb: 2 }}>
            If you are located in the European Economic Area (EEA) or United Kingdom, you have certain data protection
            rights under the General Data Protection Regulation (GDPR). These rights include:
          </Typography>
          <Box component="ul" sx={{ pl: 3, mb: 2 }}>
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
            ...
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
                <strong>Right to Erasure:</strong> You can request deletion of your personal data under certain
                circumstances
              </Typography>
            </li>
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
                <strong>Right to Restrict Processing:</strong> You can request restriction of processing of your
                personal data
              </Typography>
            </li>
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
                <strong>Right to Data Portability:</strong> You can request transfer of your data to another service
                provider
              </Typography>
            </li>
            <li>
            ...
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
                <strong>Right to Withdraw Consent:</strong> You can withdraw consent at any time where we rely on
                consent to process your data
              </Typography>
            </li>
          </Box>
          <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8, mb: 2 }}>
            To exercise any of these rights, please contact us using the contact information provided at the end of this
            Privacy Policy.
          </Typography>
          <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
            We process your personal data lawfully, transparently, and only for specified purposes as outlined in this
            Privacy Policy. We will retain your personal data only for as long as necessary to fulfill the purposes
          ...
          <Box component="ul" sx={{ pl: 3, mb: 2 }}>
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
                ...
                perform services on our behalf (hosting, payment processing, analytics)
              </Typography>
            </li>
            <li>
              <Typography variant="body1" sx={{ color: colors.neutral.gray700, lineHeight: 1.8 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body2" sx={{ color: colors.neutral.gray600, mt: 2, fontStyle: 'italic' }}>
            For GDPR-related requests, please include "GDPR Request" in your subject line for faster processing.
          </Typography>
        </Box>
      </Paper>
    </Container>
