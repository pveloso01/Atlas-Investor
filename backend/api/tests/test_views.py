...
class RegionViewSetTest(TestCase):
    ...
    def test_list_regions(self):
        ...
        Region.objects.create(name="Porto", code="OPO")  # type: ignore[attr-defined]
    ...
    def test_region_ordering(self):
        ...
        Region.objects.create(name="Cascais", code="CAS")  # type: ignore[attr-defined]
    ...
    def test_price_range_action_pagination(self):
        ...
        # We have 25 properties created in this test
        ...
        self.assertEqual(len(response_page2.data["results"]), 5)  # Remaining 5 items
