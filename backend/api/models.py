...
class Property(models.Model):
    ...
    floor_number = models.IntegerField(null=True, blank=True, help_text="Floor number (for apartments)")
    ...
    # Energy & Environment
    energy_rating = models.CharField(max_length=2, choices=ENERGY_RATING_CHOICES, null=True, blank=True)
    ...
    last_synced_at = models.DateTimeField(null=True, blank=True, help_text="Last time data was synced from source")
